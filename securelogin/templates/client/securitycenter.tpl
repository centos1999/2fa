<div class="container" style="max-width:980px;margin-top:-45px;" id="sc-root" data-whmcs-lang="{$whmcs_language|default:$language|default:'chinese'}" data-totp-uri="{$totp_provisioning_uri|escape:'html'}" data-disable-attempts-left="{$disable_attempts_left|default:0}" data-disable-max-attempts="{$disable_max_attempts|default:5}" data-disable-lock-seconds="{$disable_lock_seconds|default:0}">
  {literal}<style>
