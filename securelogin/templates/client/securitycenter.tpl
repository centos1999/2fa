      ...
      {if $totp_enabled}
        ...
        <form method="post">
          ...
          <div style="display:flex;gap:8px;flex-wrap:wrap;">
            <input class="form-control" type="password" name="confirm_password" maxlength="255" style="max-width:240px;" placeholder="Account password" autocomplete="current-password" />
